    ...
    <section id="contact" className="section-padding bg-oxford-blue pb-32">
      <div className="container-width">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {/* Contact Form */}
          <div className="bg-federal-blue border border-glaucous/20 rounded">
            <div className="p-8">
          ...
          <div className="space-y-8">
            {/* Instagram Card */}
            <div className="bg-federal-blue border border-glaucous/20 rounded hover:bg-glaucous smooth-transition">
              <a
