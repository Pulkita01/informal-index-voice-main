...
const AboutSection = () => {
  ...
  const initiatives = [
    ...
    },
    {
      ...
      description: "We work to make government schemes and policies more accessible for informal workers by explaining benefits, guiding them through applications, and assisting with registrations."
    }
  ];
